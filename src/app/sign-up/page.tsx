    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center px-6 py-12 bg-surface">
        <div className="w-full max-w-sm">
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg mb-6 text-b4">
              {error}
            </div>
          )}
          ...
          <button
            ...
            disabled={isLoading}
            type="button"
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-border rounded-lg hover:bg-teal-10 transition-colors mb-6 disabled:opacity-50 disabled:cursor-not-allowed"
          >
