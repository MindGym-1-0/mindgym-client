  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-3xl bg-[#0C6B58] p-8 text-white">
        <p className="mb-2 text-sm opacity-80">Final interview - Tomorrow - 10:00AM</p>

        <h2 className="max-w-md text-4xl font-semibold leading-tight">Product Designer @ Google</h2>

        <p className="mt-3 text-sm opacity-80">Google Meet - Final round - 6 prep sessions done</p>
      ...
      <div className="grid grid-cols-4 gap-6">
        <div className="rounded-2xl bg-white p-6 shadow-sm">
          <h3 className="text-4xl font-semibold text-[#0C6B58]">6</h3>
          <p className="mt-2 text-sm text-gray-500">Sessions done</p>
        </div>

        <div className="rounded-2xl bg-white p-6 shadow-sm">
          <h3 className="text-4xl font-semibold text-[#F59E0B]">3</h3>
          <p className="mt-2 text-sm text-gray-500">Day streak</p>
        </div>

        <div className="rounded-2xl bg-white p-6 shadow-sm">
          <h3 className="text-4xl font-semibold text-[#0C6B58]">+12%</h3>
          <p className="mt-2 text-sm text-gray-500">Confidence lift</p>
        </div>

        <div className="rounded-2xl bg-white p-6 shadow-sm">
          <h3 className="text-4xl font-semibold text-[#1A1A1A]">2</h3>
